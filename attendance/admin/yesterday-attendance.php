            ...
            <div class="tile-body">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  ...
                  $sql="SELECT * FROM attendance join employee ON employee.id=attendance.empId
left join department on employee.department_name=department.id where date(checkInTime)=CURDATE()-1";
