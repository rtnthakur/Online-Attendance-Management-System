...
$sql="update employee set fname=:fname,lname=:lname,country=:country,state=:state,city=:city,address=:address,dob=:dob,photo=:Photo where EmpId=:empid";
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          dob, date_of_joining, create_date,department.DepartmentName as DeptName,department.id as Deptid FROM employee join department 
          on employee.department_name=department.id
          where employee.EmpId=:pid";
